...
export type AgentGraphDisplayMode = 'embedded' | 'floating' | 'hidden';

export interface Settings {
  agentGraphExpanded: boolean;
  agentGraphDisplayMode: AgentGraphDisplayMode;
}
...
interface SettingsContextType {
  ...
  setAgentGraphDisplayMode: (mode: AgentGraphDisplayMode) => void;
}

const defaultSettings: Settings = {
  agentGraphExpanded: false, // Hidden by default
  agentGraphDisplayMode: 'floating', // Default: floating panel
};
...
export function SettingsProvider({ children }: { children: ReactNode }) {
  ...
  const setAgentGraphDisplayMode = (mode: AgentGraphDisplayMode) => {
    updateSettings({ agentGraphDisplayMode: mode });
  };
